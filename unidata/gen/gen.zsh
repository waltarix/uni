...
mkdir -p .cache
get 'https://unicode.org/Public/15.1.0/ucd/Blocks.txt'
get 'https://unicode.org/Public/15.1.0/ucd/EastAsianWidth.txt'
get 'https://unicode.org/Public/15.1.0/ucd/PropList.txt'
get 'https://unicode.org/Public/15.1.0/ucd/PropertyValueAliases.txt'
get 'https://unicode.org/Public/15.1.0/ucd/UnicodeData.txt'
get 'https://unicode.org/Public/15.1.0/ucd/emoji/emoji-test.txt'
